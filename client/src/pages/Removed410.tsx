...
export default function Removed410() {
  ...
  return (
    <>
      <SEO
        title="Conteúdo removido | IluminaSun"
        description="Este endereço não está mais disponível."
        canonical={`https://iluminasun.com.br${location}`}
        ogType="website"
        ogImage="https://iluminasun.com.br/logo.png"
